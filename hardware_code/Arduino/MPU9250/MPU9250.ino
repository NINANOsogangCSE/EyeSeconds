...
void setup()
{
  ...
  // Set up the alertPin from server
  pinMode(alertSignalPin, INPUT);
...
{  
  ...
  int alertValue = digitalRead(alertSignalPin);
  if (alertValue == HIGH){
    Serial.println("WOW!!!\n");
      tone(9,3136,50);
  }
  ...
  if (AHRS) {
    ...
    if (delt_t > 500) {
      ...
      mySerial.println(String((int)(1000*ax)) + String('\t') + String((int)(1000*ay)) + String('\t') + String((int)(1000*az)) + String('\t') + String((int)(gx)) + String('\t') + String((int)(gy)) + String('\t') + String((int)(gz)) + String('\t') + String((int)(yaw)) + String('\t') + String((int)(pitch)) + String('\t') + String((int)(roll))); 
    }
  }
}
